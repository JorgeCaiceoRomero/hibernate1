package pojos;
// Generated 21 abr 2021 17:26:56 by Hibernate Tools 5.4.30.Final
...
public class DepartamentoHome {
	...
	public Departamento findById(int id) {
		...
		try {
			Departamento instance = (Departamento) sessionFactory.getCurrentSession().get("mappedFiles.Departamento",
					id);
			if (instance == null) {
	...
	public List findByExample(Departamento instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("mappedFiles.Departamento")
