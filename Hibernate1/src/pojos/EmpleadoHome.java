...
public class EmpleadoHome {
	...
	public Empleado findById(int id) {
		...
		try {
			Empleado instance = (Empleado) sessionFactory.getCurrentSession().get("mappedFiles.Empleado", id);
			if (instance == null) {
	...
	public List findByExample(Empleado instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("mappedFiles.Empleado")
